...
namespace AutoAdapter.Tests.AssemblyToProcess.StaticMethodToInterfaceTests.OptionalExtraParameterOnSourceMethodWithConstantDefaultValueTest.Int64Constant
{
    ...
    {
        public static string Concat(string value, long extraParameter = 1)
        {
