...
namespace AutoAdapter.Tests.AssemblyToProcess.InterfaceToInterfaceTests.OptionalExtraParameterOnSourceInterfaceWithConstantDefaultValueTest.Int64Constant
{
    ...
    {
        string Concat(string value, long extraParameter = 1);
    }
    ...
    {
        public string Concat(string value, long extraParameter)
        {
